...
const project = {
  "slug": "music-intelligence-platform",
  ...
  "githubUrl": "https://github.com/Justin21523/music-intelligence-platform",
  "readmeUrl": "https://github.com/Justin21523/music-intelligence-platform#readme",
  ...
  "features": [
    "Detected technical signals: Python, FastAPI, React, TypeScript, Vite, DuckDB, FAISS, BM25, Recommender Systems, Playwright, Docker,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, FastAPI, React, TypeScript, Vite, DuckDB, FAISS, BM25, Recommender Systems, Playwright, Docker,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "This field needs a reviewed architecture summary based on Python",
      "status": "Review",
      "owner": "Data"
    }
  ]
